...
Bucks Bible (formerly TradeWise) is a Next.js 15 trading risk management tool with AI-powered trade amount suggestions using Genkit and Google AI (Gemini 2.0 Flash).
